// Update just the mash step type enum in the existing recipes collection
use("brewlytix");

// Update the existing collection validator to include all BeerXML mash step types
db.runCommand({
  collMod: "recipes",
  validator: {
    $jsonSchema: {
            ...
            steps: {
              ...
              items: {
                ...
                properties: {
                  ...
                  step_temp_C: { bsonType: ["double", "int"] },
...
print("✅ Updated recipes collection schema with comprehensive BeerXML mash step types!");
